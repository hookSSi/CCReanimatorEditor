module.exports = {
    'name': 'CCReanimatorEditor',
    'cocos': 'Open Cocos Panel',
    'native': 'Open Native Panel',
    'setting': 'Setting',
    'checkUpdate': 'Check Update',
    // update
    'currentLatest': 'Currently the latest version!',
    'hasNewVersion': 'New version found: ',
    'releases': 'Releases: https://gitee.com/ifaswind/ccc-extension-template/releases',
    'cocosStore': 'Cocos Store: http://store.cocos.com/app/detail/3037',
    // main
    'hello': 'Hello!',
    'greet': 'How are you?',
    'nice': 'I\'m great, nice to meet you!',
    // cocos
    'cocosTitle': 'This is a Cocos Creator panel',
    // native
    'nativeTitle': 'This is a Electron panel',
    // setting
    'none': 'None',
    'selectKey': 'Hotkey',
